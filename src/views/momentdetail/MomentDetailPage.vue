...
<template>
  <main>
    <TopNav>
      <template #left>
        <div class="flex items-center w-full">
          ...
          />
          <div
            class="user-info flex items-center w-52 ml-2"
      ...
      <template #right>
        ...
        <van-button
          v-else
          @click="$router.push(`/chat/${postUserInfo?.user_id}`)"
          class="w-20"
          type="success"
          round
          plain
    ...
    <div class="p-2">
      <div class="moment-content">
        ...
        <div class="content-resource my-2 columns-2 flex-wrap">
          <template
            v-for="(img, index) in momentData?.images"
            :key="img.image_id"
          >
            <van-image
    ...
    <van-action-bar class="p-2">
      <van-field
        class="flex-1 m-2 rounded-md outline outline-1 outline-blue-300"
