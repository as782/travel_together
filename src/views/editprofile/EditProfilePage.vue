...
const form = reactive<UserInfo>({
  ...userInfo,
  tags: userInfo?.tags?.map((e) => e.tag_id)
} as UserInfo)
// 提交表单
...
<template>
  <div class="bg-transparent">
    <!-- 头像上传，展示 -->
    <div
      class="flex justify-center items-center bg-fixed bg-cover"
      :style="{
