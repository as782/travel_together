...
<template>
    <div class="container">
        <van-button class="cos-button" :style="{ width: isFollow ? '240px' : '' }" :class="leftBtnColorClass"
            @click="handleClickChat">私聊</van-button>
        <button v-show="!isFollow" class="cos-button" :class="rightBtnColorClass" @click="handleClickFollow">关注</button>
    </div>
